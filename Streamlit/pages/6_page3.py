...
with col1:
    ...
    if branch_row['Mean_iat'] < 7.0:
        mean_iat = st.slider('Mean Inter-Arrival Time (mins)', 1.0, 7.0, branch_row['Mean_iat'], step=0.05, 
                            help='This adjusts the daily mean inter-arrival time of customers seeking to do short transactions.')
    else:
        mean_iat = st.slider('Mean Inter-Arrival Time (mins)', 1.0, branch_row['Mean_iat'] +5.0, branch_row['Mean_iat'], step=0.05, 
                            help='This adjusts the daily mean inter-arrival time of customers seeking to do short transactions.')
